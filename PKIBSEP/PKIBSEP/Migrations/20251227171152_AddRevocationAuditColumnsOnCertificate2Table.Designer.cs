...
namespace PKIBSEP.Migrations
{
    ...
    [Migration("20251227171152_AddRevocationAuditColumnsOnCertificate2Table")]
    partial class AddRevocationAuditColumnsOnCertificate2Table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PKIBSEP.Models.Certificate.Certificate2", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("SerialNumberHex")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("PKIBSEP.Models.Certificate.Certificate2", b =>
                {
                    b.HasOne("PKIBSEP.Models.Certificate.Certificate2", "Issuer")
                        .WithMany()
                        .HasForeignKey("IssuerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PKIBSEP.Models.User", "Subject")
                        .WithMany()
